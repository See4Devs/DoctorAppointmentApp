...
namespace Application.Infrastructure.Migrations
{
    ...
    [Migration("20230221180846_updatingModels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Application.Domain.Dao.Appointment", b =>
                {
                    b.HasOne("Application.Domain.Dao.Doctor", "Doctor")
                        .WithMany("Appointments")
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Application.Domain.Dao.Event", "Event")
                        .WithMany("Appointments")
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Application.Domain.Dao.Patient", "Patient")
                        .WithMany("Appointments")
